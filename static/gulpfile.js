...
gulp.task('copyAddonsScripts', function() {
    ...
    var aScript23 = gulp.src(['node_modules/inputmask/dist/inputmask/phone-codes/phone.js'])
        .pipe(gulp.dest('./vendors/inputmask'));
    var aScript24 = gulp.src(['node_modules/inputmask/dist/inputmask/phone-codes/phone-be.js'])
        .pipe(gulp.dest('./vendors/inputmask'));    
    var aScript25 = gulp.src(['node_modules/inputmask/dist/inputmask/phone-codes/phone-ru.js'])
        .pipe(gulp.dest('./vendors/inputmask'));
    var aScript26 = gulp.src(['node_modules/inputmask/dist/inputmask/bindings/inputmask.binding.js'])
        .pipe(gulp.dest('./vendors/inputmask'));
    ...
    var aScript71 = gulp.src(['./node_modules/summernote/dist/**/*'])
        .pipe(gulp.dest('./vendors/summernote/dist'));
    var aScript72 = gulp.src(['./node_modules/tinymce/**/*'])
        .pipe(gulp.dest('./vendors/tinymce'));
    var aScript73 = gulp.src(['./node_modules/ace-builds/src-min/**/*'])
        .pipe(gulp.dest('./vendors/ace-builds/src-min'));
    var aScript74 = gulp.src(['./node_modules/lightgallery/dist/**/*'])
...
gulp.task('copyAddonsStyles', function() {
    ...
    var aStyle52 = gulp.src(['node_modules/ion-rangeslider/css/ion.rangeSlider.skinFlat.css'])
        .pipe(gulp.dest('./vendors/ion-rangeslider/css'));
    ...
    var aStyle54 = gulp.src(['node_modules/pwstabs/assets/jquery.pwstabs.min.css'])
        .pipe(gulp.dest('./vendors/pwstabs'));
    return merge(aStyle1, aStyle2, aStyle3, aStyle4, aStyle5, aStyle6, aStyle7, aStyle8, aStyle9, aStyle10, aStyle11, aStyle12, aStyle13, aStyle14, aStyle15, aStyle16, aStyle17, aStyle18, aStyle19, aStyle20, aStyle21, aStyle22, aStyle23, aStyle24, aStyle25, aStyle26, aStyle27, aStyle28, aStyle29, aStyle30, aStyle31, aStyle32, aStyle33, aStyle34, aStyle35, aStyle36, aStyle37, aStyle38, aStyle39, aStyle40, aStyle41, aStyle42, aStyle43, aStyle44, aStyle45, aStyle46, aStyle47, aStyle48, aStyle49, aStyle50, aStyle51, aStyle52, aStyle53, aStyle54);
});

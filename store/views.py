...
def register_product(request):
    ...
    if request.method == "POST":
        ...
        Product.product_add(organization, request.POST.get('name'), request.POST.get('barcode'),request.POST.get('description'), request.POST.get('hsn_code'), request.POST.get('sku_code'), request.POST.get('quantity'), request.POST.get('price'), request.POST.get('cgst'), request.POST.get('sgst'), request.POST.get('igst'))
